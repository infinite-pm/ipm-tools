...
**Source:** gl:docs/dev/layout-gen/layout-alg.md#L2971-L2972 | [docs/dev/layout-gen/layout-alg.md](../../docs/dev/layout-gen/layout-alg.md#long-event-widens-and-stays-centered)
...
- ✓ [Line 2983](gl:docs/dev/layout-gen/layout-alg.md#L2983): `type=event text-len>=190 has width>=240` ([long-event-widens-and-stays-centered.dsl](../layout-gen-rules/long-event-widens-and-stays-centered.dsl))
- ✓ [Line 2984](gl:docs/dev/layout-gen/layout-alg.md#L2984): `type=event text-len<190 has width=120` ([long-event-widens-and-stays-centered-02.dsl](../layout-gen-rules/long-event-widens-and-stays-centered-02.dsl))
- ✓ [Line 2985](gl:docs/dev/layout-gen/layout-alg.md#L2985): `each $a(type=event) ~L~ $b(type=event) has $a,$b same center-x` ([long-event-widens-and-stays-centered-03.dsl](../layout-gen-rules/long-event-widens-and-stays-centered-03.dsl))
