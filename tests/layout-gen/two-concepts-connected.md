...
**Source:** gl:docs/dev/layout-gen/layout-alg.md#L1923-L1924 | [docs/dev/layout-gen/layout-alg.md](../../docs/dev/layout-gen/layout-alg.md#two-concepts-connected)
...
- ✓ [Line 1940](gl:docs/dev/layout-gen/layout-alg.md#L1940): `#c-Y is below #c-X with gap=40` ([two-concepts-connected.dsl](../layout-gen-rules/two-concepts-connected.dsl))
- ✓ [Line 1941](gl:docs/dev/layout-gen/layout-alg.md#L1941): `#c-X,#c-Y have same center-x` ([two-concepts-connected-02.dsl](../layout-gen-rules/two-concepts-connected-02.dsl))
