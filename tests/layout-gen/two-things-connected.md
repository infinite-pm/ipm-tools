...
**Source:** gl:docs/dev/layout-gen/layout-alg.md#L1635-L1636 | [docs/dev/layout-gen/layout-alg.md](../../docs/dev/layout-gen/layout-alg.md#two-things-connected)
...
- ✓ [Line 1651](gl:docs/dev/layout-gen/layout-alg.md#L1651): `#t1pA is above #t1 with gap=40` ([two-things-connected.dsl](../layout-gen-rules/two-things-connected.dsl))
- ✓ [Line 1652](gl:docs/dev/layout-gen/layout-alg.md#L1652): `#t1pA,#t1 have same center-x` ([two-things-connected-02.dsl](../layout-gen-rules/two-things-connected-02.dsl))
